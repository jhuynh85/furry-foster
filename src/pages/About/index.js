    ...
    return (
      <div className="container is-fluid">
        ...
        <div className="content">
          ...
          <p>
            Sadly, over 4 Million Shelter Pets are euthanized every year. We believe foster families
            can change that.
          </p>

          <p>
            9,000 shelter pets a day are killed, not because of aggression, behavior or illness but
            simply due to a lack of space and resources. By introducing animals lovers to fostering
            and joining forces with local rescues and shelters, many more animal lives can be saved.
          </p>
